  ...
  <div className="accordion-item">
    ...
    <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      <div className="accordion-body" style={myStyle}>
        ...
        <p>Contact : 03034253072</p> 
      <p>e-mail :  umairprince0303@gmail.com</p>
    </div>
    </div>
  </div>
  <div className="accordion-item" style={myStyle}>
    ...
    <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      <div className="accordion-body" style={myStyle}>
        <p>With the name of Allah who most gracious and merciful.</p>
        <p>I am learning react js from code with Harray and I hope this is the most suitable course for learning react for a beginer.</p>
        <p>Contact : 03088973266</p> 
      <p>e-mail :  Tauheed.Safi.tsm@gmail.com</p>
      </div>
    </div>
  </div>
  <div className="accordion-item" style={myStyle}>
    ...
    <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      <div className="accordion-body" style={myStyle}>
        <p>With the name of Allah who most gracious and merciful.</p>
        <p>I am learning react js from code with Harray and I hope this is the most suitable course for learning react for a beginer.</p>
        <p>Contact : 03015870761</p> 
      <p>e-mail :  maheerakbar@gmail.com</p>
      </div>
    </div>
  </div>
</div>
